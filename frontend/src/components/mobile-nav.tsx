  ...
  return (
    <nav className="md:hidden fixed inset-x-0 bottom-0 z-50">
      <div className="relative mx-auto max-w-screen-sm">
        <div className="bg-background dark:bg-darkBlue border-t border-border px-2 py-2 flex items-center justify-between rounded-t-2xl shadow-[0_-6px_24px_rgba(0,0,0,0.08)]">
        ...
        <button
          ...
          className="absolute left-1/2 -translate-x-1/2 -top-2 h-16 w-16 rounded-full bg-midBlue text-lightPurple dark:bg-lightPurple dark:text-darkBlue flex items-center justify-center active:scale-95 transition border-4 border-background dark:border-darkBlue"
        >
